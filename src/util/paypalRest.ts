...
import { PAYPAL_CLIENT_ID, PAYPAL_CLIENT_SECRET, PAYPAL_REST_API_URL } from '../config/settings';
...
export const payPalClient
  = new PayPalRESTClient(PAYPAL_CLIENT_ID, PAYPAL_CLIENT_SECRET, PAYPAL_REST_API_URL);
